...
A documentação deste conjunto de dados está sendo feita de forma aberta e colaborativa no [Github](https://github.com/dvcc-ses-mg/violenciageral). Existem duas alternativas para enviar sua contribuição:

- [Pull requests](https://github.com/dvcc-ses-mg/violenciageral/pulls): Para sugerir uma alteração concreta na documentação.
